...
#            After line 225 it is on line 36
#                    the code in   turtle2   run?
#            After line 225 it is on line 38 and 39
#                    the code in   turtle3   run?
#            After line 225 it is on line 37
#       -- For each of the above, WHY does that code run when it does?
#            It finds a function, then its definition. main is defined before
#           its executes. The respective function is called on line 36,
# 37 38 and 39 as told bellow.When a fucion is called, the difinition is found
#           and exicuted.
#
#     ** ASK QUESTIONS if you are uncertain. **
#
